...
for site in "nojournal-nocache"; do
  nclients=1
  ...
  #for i in `seq 0 2`; do
    ./ansible-playbook.sh -e site=$site -e nfiles=200000 ../workloads/creates.yml
  #done
  
  # baseline the drop delays
  #./ansible-playbook.sh -e site=$site -e nfiles=100000 -e drop_delay=15 ../workloads/stat.yml
  #./ansible-playbook.sh -e site=$site -e nfiles=200000 -e drop_delay=60 ../workloads/touch.yml
