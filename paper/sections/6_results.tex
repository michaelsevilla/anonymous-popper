...
Figure~\ref{fig:slowdown-strong-eventual} shows the runtimes of eventual and
...
% Does not scale?
% Strong Consistency > 10X slower than Eventual Consistency 
...
% Eventual Consistency benefit not due to metadata format
...
\subsubsection{Benefits of Isolated Subtree Policies}
