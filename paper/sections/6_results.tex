...
\begin{figure}[tb]
\centering
\includegraphics[width=75mm]{graphs/slowdown-mechanisms.png}
\caption{}
\end{figure}
\begin{figure}[tb]
\centering
\includegraphics[width=75mm]{graphs/slowdown-related-work.png}
\caption{}
\end{figure}
\begin{figure}[tb]
\centering
\includegraphics[width=75mm]{graphs/slowdown-strong-v-eventual.png}
\caption{}
\end{figure}
