...
\noindent\textbf{CudeleFS}: the journal format is used by ``Stream", ``Create",
...
mechanisms are implemeted by writing with the journal format.  By writing with
...
``Create", ``Volatile Apply", and ``Nonvolatile Apply".  
